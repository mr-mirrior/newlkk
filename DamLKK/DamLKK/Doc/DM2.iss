...
[Icons]
Name: "{group}\大坝填筑质量GPS监控系统"; Filename: "{app}\dmlkk"
Name: "{commondesktop}\大坝填筑质量GPS监控系统"; Filename: "{app}\dmlkk"; Tasks: desktopicon
Name: "{userappdata}\Microsoft\Internet Explorer\Quick Launch\DM2"; Filename: "{app}\dmlkk"; Tasks: quicklaunchicon
